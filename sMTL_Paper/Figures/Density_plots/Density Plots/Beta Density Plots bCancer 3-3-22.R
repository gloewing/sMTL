...
ggsave( paste0("~/Desktop/Research Final/Sparse Multi-Study/Figures/Density Plots/bCancer_betas_50rug.pdf"),
        plot = betaDensity4,
        width = 14,
        height = 20)
...
ggsave( paste0("~/Desktop/Research Final/Sparse Multi-Study/Figures/Density Plots/bCancer_betas_50Randomrug.pdf"),
        plot = betaDensity4,
        width = 14,
        height = 20)

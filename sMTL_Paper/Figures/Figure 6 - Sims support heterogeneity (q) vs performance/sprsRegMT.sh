...
#SBATCH --time 0-167:00       # Wall time limit in D-HH:MM
#SBATCH --mem 6000     # Memory limit for each tasks (in MB) # 1500
#SBATCH -o /n/home12/gloewinger/error/output_sparseMT.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /n/home12/gloewinger/error/errors_sparseMT.err  # File to which STDERR will be written, %j inserts jobid
#SBATCH --array 1-100
...
Rscript '/n/home12/gloewinger/sparse_multiStudy_IHT_MT.R' $1 # /n/home08/nhuey/De_bias_CCA/codes/vers8/DB.R $1 $2 $3 $4 $5

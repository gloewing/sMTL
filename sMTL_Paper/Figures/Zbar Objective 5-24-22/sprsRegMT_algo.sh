...
#SBATCH --mem 3500     # Memory limit for each tasks (in MB) # 1500
...
Rscript '/n/home12/gloewinger/sparse_multiStudy_IHT_MT_algorithm.R' $1 # /n/home08/nhuey/De_bias_CCA/codes/vers8/DB.R $1 $2 $3 $4 $5

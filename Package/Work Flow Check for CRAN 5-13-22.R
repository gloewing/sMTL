...
# install new one
install.packages("/Users/gabeloewinger/Desktop/Research Final/Sparse Multi-Study/CRAN Package/Original Code used to Build Package/sMTL_0.1.0.tar.gz", 
...
setwd("~/Desktop/Research Final/Methods Paper/studyStrap Package/Original Code used to Build Package")
devtools::check_win_release("studyStrap")
devtools::check_win_devel("studyStrap")

## check before submission on your computer
setwd("~/Desktop/Research Final/Methods Paper/studyStrap Package/Original Code used to Build Package")
spell_check("~/Desktop/Research Final/Methods Paper/studyStrap Package/Original Code used to Build Package/studyStrap")
check_rhub("~/Desktop/Research Final/Methods Paper/studyStrap Package/Original Code used to Build Package/studyStrap")

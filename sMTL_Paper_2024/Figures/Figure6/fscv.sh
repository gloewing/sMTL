#!/bin/bash
#SBATCH --job-name smtl_fscv      # Set a name for your job. This is especially useful if you
#SBATCH --partition norm     # Slurm partition to use: quick, norm, 
...
#SBATCH --time 2-03:59       # Wall time limit in D-HH:MM
#SBATCH --mem 6000     # Memory limit for each tasks (in MB) # 1500
#SBATCH -o /home/loewingergc/error/smtl_fscv.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /home/loewingergc/error/smtl_fscv.err  # File to which STDERR will be written, %j inserts jobid
#SBATCH --array 1-100
...
Rscript '/home/loewingergc/smtl/code/fscv_multiStudy_IHT_cf_MT.R' $1 $2
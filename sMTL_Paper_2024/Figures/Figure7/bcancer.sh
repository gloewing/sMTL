#!/bin/bash
#SBATCH --job-name smtl_bcancer      # Set a name for your job. This is especially useful if you
...
#SBATCH --time 1-00:59       # Wall time limit in D-HH:MM
#SBATCH --mem 10000     # Memory limit for each tasks (in MB) # 1500
#SBATCH -o /home/loewingergc/error/smtl_bcancer.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /home/loewingergc/error/smtl_bcancer.err  # File to which STDERR will be written, %j inserts jobid
#SBATCH --array 1-180
...
Rscript '/home/loewingergc/smtl/code/sparse_MT_breast_random.R' $1 $2